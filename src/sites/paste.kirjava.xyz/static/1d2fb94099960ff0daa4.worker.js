...
/* harmony import */ var javascript_packer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! javascript-packer */ "./node_modules/javascript-packer/lib/index.js");
/* harmony import */ var javascript_packer__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(javascript_packer__WEBPACK_IMPORTED_MODULE_0__);


self.onmessage = function (_ref) {
  var _ref$data = _ref.data,
      code = _ref$data.code,
      shouldEval = _ref$data.shouldEval;
  // self.postMessage({ code: JSFuck.encode(code, shouldEval) });
  console.log(javascript_packer__WEBPACK_IMPORTED_MODULE_0___default.a); // code, base62, shrink
};

/***/ }),

/***/ "./node_modules/javascript-packer/lib/index.js":
/*!*****************************************************!*\
  !*** ./node_modules/javascript-packer/lib/index.js ***!
  \*****************************************************/
...
var WebpackPacker = (function () {
    function WebpackPacker(options, excludes) {
        this.options = {};
    ...
    WebpackPacker.prototype.apply = function (compiler) {
        var _this = this;
        compiler.plugin('compilation', function (compilation) {
            compilation.plugin("optimize-chunk-assets", function (chunks, callback) {
                ...
                files.forEach(function (file) {
                    ...
                    var packed = _this.packer.pack(input, true, true);
                    
                    compilation.assets[file] = new RawSource(packed.toString());
                });
                callback();
            });
        });
    };
    WebpackPacker.prototype.shouldExclude = function (filePath, excludes) {
    ...
    return WebpackPacker;
}());
module.exports = WebpackPacker;
...
/******/ });
//# sourceMappingURL=1d2fb94099960ff0daa4.worker.js.map