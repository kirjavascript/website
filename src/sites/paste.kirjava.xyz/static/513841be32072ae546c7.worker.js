...
self.onmessage = function (_ref) {
  ...
  self.postMessage({
    code: packer.pack(code, true, true)
  }); // code, base62, shrink
};
/* eslint-disable */
...
new function (_) {
  ...
  var Package = Base.extend({
    constructor: function constructor(d, e) {
      this.extend(e);
    ...
    addPackage: function addPackage(a) {
  ...
  var Module = Abstract.extend(null, {
    ...
    implement: function implement(c) {
      var d = this;
  ...
  var Collection = Map.extend({
    ...
    insertAt: function insertAt(a, b, c) {
    ...
    extend: function (_extend2) {
      function extend(_x3, _x4) {
        return _extend2.apply(this, arguments);
      }

      extend.toString = function () {
        return _extend2.toString();
      };
  ...
  var Array2 = _23(Array, Array, "concat,join,pop,push,reverse,shift,slice,sort,splice,unshift", [Enumerable, {
    ...
    removeAt: function removeAt(a, b) {
  ...
  Array2.like = function (a) {
    return !!(a && _typeof(a) == "object" && typeof a.length == "number");
  };
  ...
  var Date2 = _23(Date, function (a, b, c, h, m, s, d) {
    ...
    toISOString: function toISOString(c) {
      var d = "####-##-##T##:##:##.###";
  ...
  function instanceOf(a, b) {
    ...
    switch (b) {
      case Array:
        return !!(_typeof(a) == "object" && a.join && a.splice);
      ...
      case Number:
      case Boolean:
        return _typeof(a) == _typeof(b.prototype.valueOf());
  ...
  function assertType(a, b, c) {
    if (b && (typeof b == "function" ? !instanceOf(a, b) : _typeof(a) != b)) {
...
new function (_) {
  ...
  var Interface = Module.extend(null, {
    ...
    createDelegate: function createDelegate(a, b) {
      if (!this[a]) {
  ...
  var Binding = Interface.extend(null, {
    extend: function (_extend3) {
      function extend(_x5, _x6) {
        return _extend3.apply(this, arguments);
      }

      extend.toString = function () {
        return _extend3.toString();
      };
  ...
  var Node = Binding.extend({
    "@!(element.compareDocumentPosition)": {
      compareDocumentPosition: function compareDocumentPosition(a, b) {
  ...
  var Element = Node.extend({
    "@MSIE.+win": {
      getAttribute: function getAttribute(a, b, c) {
  ...
  var Traversal = Module.extend({
    getDefaultView: function getDefaultView(a) {
      return this.getDocument(a).defaultView;
    },
    getNextElementSibling: function getNextElementSibling(a) {
    ...
    getOwnerDocument: function getOwnerDocument(a) {
      return a.ownerDocument;
    },
    getPreviousElementSibling: function getPreviousElementSibling(a) {
    ...
    getTextContent: function getTextContent(a) {
      return a[TEXT];
    },
    ...
    setTextContent: function setTextContent(a, b) {
      return a[TEXT] = b;
    },
    "@MSIE": {
      getDefaultView: function getDefaultView(a) {
    ...
    getDocument: function getDocument(a) {
      return this.isDocument(a) ? a : this.getOwnerDocument(a);
    },
    isDocument: function isDocument(a) {
  ...
  var Event = Binding.extend({
    "@!(document.createEvent)": {
      initEvent: function initEvent(a, b, c, d) {
        a.type = b;
        a.bubbles = c;
        a.cancelable = d;
  ...
  var _40 = new Base({
    handleEvent: function handleEvent(a, b) {
      var c = true;
      var d = _40[a.base2ID];
  ...
  var DocumentEvent = Interface.extend({
    "@!(document.createEvent)": {
      createEvent: function createEvent(a, b) {
        return Event.bind({});
      },
  ...
  var ViewCSS = Interface.extend({
    "@!(document.defaultView.getComputedStyle)": {
      "@MSIE": {
        getComputedStyle: function getComputedStyle(b, c, d) {
          var e = c.currentStyle;
          var f = {
            getPropertyValue: function getPropertyValue(a) {
    ...
    toCamelCase: function toCamelCase(c) {
  ...
  var NodeSelector = Interface.extend({
    "@!(element.querySelector)": {
      querySelector: function querySelector(a, b) {
  ...
  extend(NodeSelector.prototype, {
    ...
    querySelectorAll: function querySelectorAll(b) {
  ...
  var CSSParser = RegGrp.extend({
    ...
    WHITESPACE: /\s*([\s>+~(),]|^|$)\s*/g,
    WILD_CARD: /\s\*\s/g,
    _47: function _47(c, d, e, f, g, h, i, j) {
      f = /last/i.test(c) ? f + "+1-" : "";
  ...
  var XPathParser = CSSParser.extend({
    ...
    rules: extend({}, {
      "@!KHTML": {
        ...
        "([ >])(\\*|[\\w-]+):([\\w-]+-child(\\(([^)]+)\\))?)": function wWChild(a, b, c, d, e, f) {
          var g = b == " " ? "//*" : "/*";
    ...
    types: {
      identifiers: function identifiers(a, b) {
        this[rescape(b) + "([\\w-]+)"] = a;
      },
      combinators: function combinators(a, b) {
        this[rescape(b) + "(\\*|[\\w-]+)"] = a;
      },
      attributes: function attributes(a, b) {
        this["\\[([\\w-]+)\\s*" + rescape(b) + "\\s*([^\\]]*)\\]"] = a;
      },
      pseudoClasses: function pseudoClasses(a, b) {
        this[":" + b.replace(/\(\)$/, "\\(([^)]+)\\)")] = a;
      }
    },
    values: {
...
new function (_) {
  ...
  var Call = Base.extend({
    constructor: function constructor(a, b, c, d) {
    ...
    init: function init() {// EventTarget.addEventListener(document, "DOMContentLoaded", function() {
      //     if (Call.list) {
      //         DOM.bind(document);
  ...
  var Rule = Base.extend({
    constructor: function constructor(e, f) {
      e = new Selector(e);
...
var Colorizer = RegGrp.extend({
  constructor: function constructor(c, d, e) {
    this.extend(e);
    this.patterns = c || {};
    var f = {},
        i;
  ...
  addScheme: function addScheme(a, b, c, d) {
...
base2.code.addName("Colorizer", Colorizer); // with(base2.code.Colorizer) addScheme("xml", {
//     attribute: /(\w+)=("[^"]*"|'[^']*')/,
//     cdata: /<!\[CDATA\[([^\]]|\][^\]]|\]\][^>])*\]\]>/,
//     comment: /<!\s*(--([^-]|[\r\n]|-[^-])*--\s*)>/,
//     entity: /&#?\w+;/,
...
var Packer = Base.extend({
  ...
  _shrinkVariables: function _shrinkVariables(script) {
    ...
    var store = function store(string) {
    ...
    var encode52 = function encode52(c) {
    ...
    var encode = function encode(block, func, args) {
      if (func) {
        // the block is a function block
        // decode the function block (THIS IS THE IMPORTANT BIT)
        // We are retrieving all sub-blocks and will re-parse them in light
        // of newly shrunk variables
        block = decode(block); // create the list of variable and argument names

        var vars = match(block, VAR_NAME).join(",").replace(VAR_, "");
        var ids = Array2.combine(args.split(COMMA).concat(vars.split(COMMA))); // process each identifier
        ...
        forEach(ids, function (id) {
          ...
          if (id && id.length > 1) {
            // > 1 char
            id = rescape(id); // find the next free short name (check everything in the current scope)

            do {
              shortId = encode52(count++);
            } while (new RegExp("[^\\w$.]" + shortId + "[^\\w$:]").test(block)); // replace the long name with the short name
    ...
    var decode = function decode(script) {
    ...
    script = Packer.data.exec(script, store); // remove closures (this is for base2 namespaces only)

    script = script.replace(/new function\(_\)\s*\{/g, "{;#;"); // encode blocks, as we encode we replace variable and argument names
    ...
    script = decode(script); // put back the closure (for base2 namespaces only)

    script = script.replace(/\{;#;/g, "new function(_){"); // put strings and regular expressions back
...
var Words = Collection.extend({
  constructor: function constructor(script) {
    this.base();
  ...
  Item: {
    constructor: function constructor(word) {
...
/******/ });
//# sourceMappingURL=513841be32072ae546c7.worker.js.map